from SimSiam.fedsimsiam.client import *
from SimSiam.fedsimsiam.server import *
from SimSiam.fedsimsiam.datapreparation import *
import argparse


if __name__=="__main__":
    """
    python3 train_fedsimsiam.py --num_clients 10 --alpha 0.5 --num_rounds 5 --local_epochs 5 --batch_size 32 --output_path 'fedsimsiam_10_40_5.pth'
    """
